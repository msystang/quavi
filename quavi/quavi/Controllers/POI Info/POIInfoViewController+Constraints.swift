...
extension POIInfoViewController{
    ...
    func easterEggButtonConstraints() {
        ...
        NSLayoutConstraint.activate([
            easterEggButton.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 10),
            easterEggButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 15),
            easterEggButton.widthAnchor.constraint(equalToConstant: 35),
            easterEggButton.heightAnchor.constraint(equalToConstant: 35)])
    }
    
    func pageControlConstraints() {
        pageControl.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            pageControl.bottomAnchor.constraint(equalTo: containerView.topAnchor),
            pageControl.widthAnchor.constraint(equalTo: containerView.widthAnchor),
    ...
    func containerViewConstraints() {
        ...
        NSLayoutConstraint.activate([
            containerView.topAnchor.constraint(equalTo: easterEggButton.bottomAnchor, constant: 30),
            containerView.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            containerView.heightAnchor.constraint(equalToConstant: view.frame.height * 0.65),
            containerView.widthAnchor.constraint(equalToConstant: view.frame.width * 0.95) ])
    }
    ...
    func likeButtonConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            likeButton.bottomAnchor.constraint(equalTo: containerView.bottomAnchor, constant: likeButton.frame.height / 2 ),
